...
import { Users, friendlist, msgList } from '../utils/index';
//import { emoji } from "./emoji";
import { emoji } from './emoji';
Vue.use(Vuex);
//获取当前时间
const now = new Date();
var MsgList = localStorage.getItem("vue-chat")
  ? JSON.parse(localStorage.getItem("vue-chat") ||"")
  : msgList;
var Friendlist = localStorage.getItem("friend-list")
  ? JSON.parse(localStorage.getItem("friend-list")|| "")
  : friendlist;
